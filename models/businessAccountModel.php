    ...
    public static function addDefaultValues()
    {
        ...
        return Configuration::updateValue(
            ...
            Configuration::updateValue(
                ...
                [$context->language->id => 'b2b-customer-create'],
                false,
                $context->shop->id_shop_group,
                $context->shop->id
            ) &&
            Configuration::updateValue(
                ...
                [$context->language->id => 'Create Business Account'],
                false,
                $context->shop->id_shop_group,
                $context->shop->id
            ) &&
            Configuration::updateValue(
                ...
                [$context->language->id => 'Personal Information'],
                false,
                $context->shop->id_shop_group,
                $context->shop->id
            ) &&
            Configuration::updateValue(
                ...
                [$context->language->id => 'Company Information'],
                false,
                $context->shop->id_shop_group,
                $context->shop->id
            ) &&
            Configuration::updateValue(
                ...
                [$context->language->id => 'Sign in Information'],
                false,
                $context->shop->id_shop_group,
                $context->shop->id
            ) &&
            Configuration::updateValue(
                ...
                [$context->language->id => 'Custom Fields'],
                false,
                $context->shop->id_shop_group,
                $context->shop->id
            ) &&
            Configuration::updateValue(
                ...
                [$context->language->id => 'Custom Page'],
                false,
                $context->shop->id_shop_group,
                $context->shop->id
            ) &&
            Configuration::updateValue(
                ...
                [$context->language->id => 'Your account is pending for validation and will be activated soon'],
                false,
                $context->shop->id_shop_group,
                $context->shop->id
            ) &&
            Configuration::updateValue(
                ...
                [$context->language->id => 'Address Information'],
                false,
                $context->shop->id_shop_group,
                $context->shop->id
            );
